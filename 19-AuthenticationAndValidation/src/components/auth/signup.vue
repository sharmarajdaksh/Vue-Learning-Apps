    ...
    <div class="signup-form">
      <form @submit.prevent="onSubmit">
        ...
        <div class="input" :class="{invalid: $v.age.$error}">
          ...
          <p v-if="!$v.age.minVal">You must be at least {{$v.age.$params.minVal.min}} years old</p>
        </div>
        ...
        <div class="hobbies">
          ...
          <div class="hobby-list">
            ...
            >You have to specify atleast {{$v.hobbyInputs.$each.params.minLen.min}} hobbies</p>
          </div>
        </div>
        ...
        <div class="submit">
          <button type="submit" :disabled="$v.$invalid || $v.$error">Submit</button>
        </div>
      </form>
    </div>
  </div>
    ...
    email: {
      ...
      unique: val => {
        ...
        return new Promise(resolve => {
          setTimeout(() => resolve(val === "test@test.com"), 2000);
        });
      }
    },
    age: {
